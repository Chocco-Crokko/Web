...
class SignupForm(forms.Form):
    ...
    email = forms.EmailField(
        label='Email',
        widget=forms.EmailInput(attrs={ 'class': 'form-control', 'placeholder': 'example@flask.com', }),
        max_length=100
    )
    password = forms.CharField(
        label='Password',
...
class QuestionForm(forms.Form):
    ...
    text = forms.CharField(
        label='Text',
        widget=forms.Textarea(attrs={'class': 'form-control noresize', 'rows': '14', 'placeholder': 'Enter your question',}),
        max_length=100000
    )
...
class AnswerForm(forms.Form):
    text = forms.CharField(
        widget=forms.Textarea(attrs={'class': 'form-control noresize', 'rows': '5', 'placeholder': 'Enter your answer', })
    )
